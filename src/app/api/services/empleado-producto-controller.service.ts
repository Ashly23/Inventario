...
import { NewProductoInEmpleado } from '../models/new-producto-in-empleado';
...
export class EmpleadoProductoControllerService extends BaseService {
   ...
   */
  static readonly EmpleadoProductoControllerFindPath = '/empleados/{id}/productos';
   ...
   */
  static readonly EmpleadoProductoControllerCreatePath = '/empleados/{id}/productos';
  ...
  /**
   * Path part for operation empleadoProductoControllerDelete
   */
  static readonly EmpleadoProductoControllerDeletePath = '/empleados/{id}/productos';
  ...
  delete$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, EmpleadoProductoControllerService.EmpleadoProductoControllerDeletePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
  ...
  /**
   * Path part for operation empleadoProductoControllerPatch
   */
  static readonly EmpleadoProductoControllerPatchPath = '/empleados/{id}/productos';
  ...
  patch$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, EmpleadoProductoControllerService.EmpleadoProductoControllerPatchPath, 'patch');
    if (params) {
      rb.path('id', params.id, {});
      rb.query('where', params.where, {});
      rb.body(params.body, 'application/json');
