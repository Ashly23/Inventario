...
export class EmpleadoAreaControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation empleadoAreaControllerGetArea
   */
  static readonly EmpleadoAreaControllerGetAreaPath = '/empleados/{id}/area';
  ...
  getArea$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, EmpleadoAreaControllerService.EmpleadoAreaControllerGetAreaPath, 'get');
    if (params) {
