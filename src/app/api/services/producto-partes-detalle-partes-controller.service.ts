...
export class ProductoPartesDetallePartesControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation productoPartesDetallePartesControllerGetPartes
   */
  static readonly ProductoPartesDetallePartesControllerGetPartesPath = '/producto-partes-detalles/{id}/partes';
  ...
  getPartes$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ProductoPartesDetallePartesControllerService.ProductoPartesDetallePartesControllerGetPartesPath, 'get');
    if (params) {
