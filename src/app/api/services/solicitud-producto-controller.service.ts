...
export class SolicitudProductoControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation solicitudProductoControllerGetProducto
   */
  static readonly SolicitudProductoControllerGetProductoPath = '/solicitud/{id}/producto';
  ...
  getProducto$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, SolicitudProductoControllerService.SolicitudProductoControllerGetProductoPath, 'get');
    if (params) {
