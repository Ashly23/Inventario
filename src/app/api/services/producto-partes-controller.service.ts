...
export class ProductoPartesControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation productoPartesControllerGetPartes
   */
  static readonly ProductoPartesControllerGetPartesPath = '/productos/{id}/partes';
  ...
  getPartes$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ProductoPartesControllerService.ProductoPartesControllerGetPartesPath, 'get');
    if (params) {
