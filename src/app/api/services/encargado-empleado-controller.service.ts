...
export class EncargadoEmpleadoControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation encargadoEmpleadoControllerGetEmpleado
   */
  static readonly EncargadoEmpleadoControllerGetEmpleadoPath = '/encargados/{id}/empleado';
  ...
  getEmpleado$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, EncargadoEmpleadoControllerService.EncargadoEmpleadoControllerGetEmpleadoPath, 'get');
    if (params) {
