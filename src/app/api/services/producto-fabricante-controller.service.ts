...
export class ProductoFabricanteControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation productoFabricanteControllerGetFabricante
   */
  static readonly ProductoFabricanteControllerGetFabricantePath = '/productos/{id}/fabricante';
  ...
  getFabricante$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ProductoFabricanteControllerService.ProductoFabricanteControllerGetFabricantePath, 'get');
    if (params) {
