...
export class EncargadoProductoControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation encargadoProductoControllerGetProducto
   */
  static readonly EncargadoProductoControllerGetProductoPath = '/encargados/{id}/producto';
  ...
  getProducto$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, EncargadoProductoControllerService.EncargadoProductoControllerGetProductoPath, 'get');
    if (params) {
